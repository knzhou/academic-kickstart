...
- **{{% staticref "handouts/E1.pdf" "newtab" %}}Elec I{{% /staticref %}} ({{% staticref "handouts/E1Sol.pdf" "newtab" %}}Sol{{% /staticref %}})**, Elec II (Sol), Elec III (Sol), {{% staticref "handouts/E4.pdf" "newtab" %}}Elec IV{{% /staticref %}} (Sol)
